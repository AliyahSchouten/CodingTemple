...
mat1 <- matrix(vec1, nrow = 3, byrow = TRUE)
mat2 <- matrix(vec2, nrow = 3, byrow = TRUE)

# Create an array of the matrices
array_of_matrices <- array(c(mat1, mat2), dim = c(3, 3, 2))
...
2.  In the above matrix that you created, print the value 5 by indexing in to the matrix.
    ...
    ```{r}
value_5 <- array_of_matrices[1, 2, 1]  # Row 1, Column 2, Matrix 1
...
3.  Print the third row of the first matrix.
    ...
    ```{r}
third_row_first_matrix <- array_of_matrices[3, , 1]
